...
import { socialMedia, footerLinks } from "../constants"; // Import your socialMedia and footerLinks data
import { envi } from "../assets";
      ...
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex-[1] flex flex-col justify-start mr-10">
          ...
          <p className={`${styles.paragraph} text-black mt-4 max-w-[312px]`}>
            Ecological Diversity is our greatest asset.
          </p>
        </div>
